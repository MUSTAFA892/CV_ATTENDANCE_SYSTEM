...
class FaceRecognition:
    ...
    def log_attendance(self, name):
        ...
        if existing_record:
            ...
            c.execute(f"UPDATE attendance SET {period_column} = 1 WHERE name=? AND timestamp >= datetime('now', 'localtime', 'start of day')", (name,))
            ...
            period_column = f"period_{period}"
            c.execute(f"INSERT INTO attendance (name, {period_column}) VALUES (?, 1)", (name,))
